      ...
      <div class="add-form">
        <table border="1" style="border-radius: 5px; width:400px;cellspacing:1px">
                     <tr>
                         ...
                         <td class="controler"><%=((User)session.getAttribute("user")).getUid() %></td>
                     </tr>
                     <tr>
                         <td class="label">用户名</td>
                         <td class="controler"><%=((User)session.getAttribute("user")).getUname() %></td>
                     </tr>
                     <tr>
                         <td class="label">密码</td>
                         <td class="controler"><%=((User)session.getAttribute("user")).getPwd() %></td>
                     </tr>
                     <tr>
                         ...
                         <%
                         	...
                         	if("1".equals(sex)){
                         %>
                         <td class="controler">男</td>
                         <%}else{ %>
                         <td class="controler">女</td>
                         <%}%>

                     </tr>
                     <tr>
                         <td class="label">年龄</td>
                         <td class="controler"><%=((User)session.getAttribute("user")).getAge() %></td>
                     </tr>
                     <tr>
                         <td class="label">出生年月</td>
                         <td class="controler"><%=((User)session.getAttribute("user")).getBirth() %></td>
                     </tr>
